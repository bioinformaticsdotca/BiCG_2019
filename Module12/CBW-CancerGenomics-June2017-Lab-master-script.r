...
data_norm_list <- lapply(data_list,standardNormalization)

## Create distance matrices for each data type 
  # (NOTE: THIS WILL TAKE A LITTLE TIME)
data_dist_list <- lapply(X = data_norm_list,
...
(cluster_nums <- lapply(X = data_aff_list,
