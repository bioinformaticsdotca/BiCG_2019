...
#View expression values for the transcripts of a particular gene symbol of chromosome 9.  e.g. 'PCA3'
...
#### Plot #3 - View the range of values and general distribution of FPKM values for all 6 libraries
...
#### Plot #6 - Create a heatmap to vizualize expression differences between the six samples
